"""
RocketSim Performance Benchmark
===============================
Benchmarks for measuring simulation throughput and latency.
"""
...
def run_benchmark():
    ...
    print("=" * 70)
    print("RocketSim JAX Performance Benchmark")
    print("=" * 70)
    ...
    def run_rollout(state, controls):
        (final_state, _), _ = lax.scan(
            rollout_scan, (state, controls), None, length=N_STEPS_THROUGHPUT
        )
        return final_state
    ...
    print("  Running continuous rollouts to analyze thermal/CPU stability...")
