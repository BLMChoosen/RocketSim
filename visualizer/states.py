...
# From RLConst.h - Small pads first (28), then big pads (6) = 34 total
# This order MUST match sim_constants.py PAD_LOCATIONS
default_boost_pad_locations = (
    # Small pads (28 total) - index 0-27
    (0.0, -4240.0, 70.0),
    (-1792.0, -4184.0, 70.0),
    (1792.0, -4184.0, 70.0),
    (-940.0, -3308.0, 70.0),
